    ...
    <>
      <div>
        <div className="w-screen-15percent relative lg:right-52">
          ...
          <div className="container mx-auto flex justify-center -mt-24 sm:-mt-44 md:-mt-64 lg:-mt-72">
            <div className="relative w-11/12 sm:w-2/3 lg:w-1/2 flex justify-center">
              <img
